...
<div class="flex flex-col lg:flex-row items-center lg:justify-center p-8 space-y-4 lg:space-y-0 lg:space-x-8">
    ...
    <div class="flex flex-col flex-grow">
        ...
        <!-- Bouton "Acheter" -->
        <button class="flex items-center bg-blue-500 text-white px-4 py-2 rounded-md focus:outline-none mb-2" onclick="afficherBoiteModale()">
            Acheter
        ...
        <!-- Bouton "Message" -->
        <button class="flex items-center bg-gray-300 text-gray-700 px-4 py-2 rounded-md focus:outline-none mb-2">
            Message
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <!-- Bouton "Appel" -->
        <button class="flex items-center bg-gray-300 text-gray-700 px-4 py-2 rounded-md focus:outline-none">
...
<div id="boiteModale" class="hidden fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center m-2">
    <div class="bg-white p-8 max-w-md mx-auto rounded">
        <p class="text-lg">Cette option n'est pas encore disponible, mais vous pouvez appeler le vendeur ou lui envoyer un message.</p>
